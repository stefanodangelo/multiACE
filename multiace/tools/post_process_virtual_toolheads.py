...
def compute_head_mode_optimize(events, feeder_heads, ace_heads=None,
    ...
    Args:
      ...
      flush_matrix:     slicer flush matrix (mm3, NxN); with objective=
                        'color' it breaks ties by transition flush volume.
      objective:        'time' (default, cost/swaps/pins only) or 'color'
                        (flush volume is the primary tiebreaker).
      cost_model:       optional swap_cost.SwapCostModel; None reproduces
                        the historical constant-cost behaviour exactly.
